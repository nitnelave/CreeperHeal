...
public class BlockManager {
	...
	private static Map<Location, CreeperBlock> toReplace = Collections.synchronizedMap(new HashMap<Location,CreeperBlock>());		//blocks to be replaced immediately after an explosion
	...
	protected static void replace_one_block(List<CreeperBlock> list) {        //replace one block (block per block)
	...
	protected static void replace_blocks(List<CreeperBlock> list) {    //replace all the blocks in the given list
		if(list == null)
			return;
